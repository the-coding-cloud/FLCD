...
class Scanner:
    def __init__(self):
        ...
        self.__identifierFA = FA("identifier_FA.in")
        self.__integerConstantFA = FA("constant_FA.in")
    ...
    def __isConstant(self, token):
        if not self.__integerConstantFA.checkSequenceAcceptance(token):
    ...
    def __isIdentifier(self, token):
        return self.__identifierFA.checkSequenceAcceptance(token)
